...
def home(request):
	...
	if request.method == 'POST':
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=50&API_KEY=1F02354C-514E-4334-A2BC-C7B170AF8696")
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=22207&distance=5&API_KEY=1F02354C-514E-4334-A2BC-C7B170AF8696")
